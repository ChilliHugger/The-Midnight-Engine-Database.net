    ...
    public class MidnightLoadingTests
    {
        ...
        public void TestEntitiesCreated()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(entities.RouteNodes.Any(), "No RouteNodes");
                Assert.That(entities.Regiments.Any(), "No Regiments");
                Assert.That(entities.Strongholds.Any(), "No Strongholds");
                Assert.That(entities.Waypoints.Any(), "No Waypoints");
                Assert.That(entities.Things.Any(), "No Things");
                Assert.That(entities.Missions.Any(), "No Missions");
                Assert.That(entities.Victories.Any(), "No Victories");
            });
        }
        ...
        public void TestInfoCreated()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.That(entities.Directions.Any(), Is.True, "No Directions");
        ...
        public void TestEntitiesLoaded()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(entities.RouteNodes.All(i => IsValidItemType(EntityType.RouteNode, i)), "RouteNodes have not loaded");
                Assert.That(entities.Regiments.All(i => IsValidItemType(EntityType.Regiment, i)), "Regiments have not loaded");
                ...
                Assert.That(entities.Missions.All(i => IsValidItemType(EntityType.Mission, i)), "Missions have not loaded");
                Assert.That(entities.Victories.All(i => IsValidItemType(EntityType.Victory, i)), "Victories have not loaded");
            });
        }
